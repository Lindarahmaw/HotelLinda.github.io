            ...
            <div class="card-body p-5">
              ...
              <form action="register-aksi.php" method="post">
                ...
                <div class="form-outline mb-4">
                  ...
                  <label class="form-label" for="form3Example4cdg">Masukan password sekali lagi</label>
                </div>
                ...
                <div class="d-flex justify-content-center">
                  <button type="button"
                    class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Register</submit>
                </div>
